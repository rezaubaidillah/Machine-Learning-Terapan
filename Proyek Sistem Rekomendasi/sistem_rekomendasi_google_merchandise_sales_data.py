# -*- coding: utf-8 -*-
"""sistem_rekomendasi_google_merchandise_sales_data.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17LCerGgSKej-fsuWYQRG9uFPsy95EQkn
...
transaksi = pd.read_csv('events1.csv')
barang = pd.read_csv('items.csv')
profil = pd.read_csv('users.csv')
...
"""karena hampir semua kolom variant memiliki nilai null di kita drop saja, kita hanya menghapus country"""
...
# prompt: column type change
# add_to_cart = 1
# begin_checkout = 2
# purchase = 3

# Assuming 'all_transaksi_name_clean' DataFrame exists from the previous code
...
# Limit to only showing top 15 items with the highest event_type from the user
print('15 item with high event_type from user ')
print('----' * 8)

# Sort by event_type and limit to top 10, remove duplicates
top_item_user = (
    item_visited_by_user.sort_values(by='event_type', ascending=False)
    .head(15)  # Limiting to top 10 items
