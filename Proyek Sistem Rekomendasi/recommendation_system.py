...
"""menampilkan masing masing jumlah baris data"""
...
"""menampilkan masing masing jumlah kolom data"""

# prompt: masing masing jumlah kolom data

print('Jumlah kolom data event yang diterima: ', len(transaksi.columns))
print('Jumlah kolom data barang: ', len(barang.columns))
print('Jumlah kolom data profil: ', len(profil.columns))

"""### Univariate Exploratory Data Analysis

##### dataframe transaksi

menampilkan informasi dataframe transaksi
"""

transaksi.info()

"""menampilkan 5 baris pertama dataframe transaksi"""

transaksi.head()

"""menampilkan jumlah dan nilai unik pada kolom dataframe transaksi"""
...
menampilkan informasi dataframe barang
"""

barang.info()

"""menampilkan 5 baris pertama  dataframe barang"""

barang.head()

"""menampilkan jumlah dan nilai unik pada kolom dataframe barang"""
...
menampilkan informasi dataframe profil
"""

profil.info()

"""menampilkan 5 baris pertama dataframe profil"""

profil.head()

"""menampilkan jumlah pada kolom dataframe barang"""
...
"""menampilkan frekuensi item id Berdasarkan Transaksi"""
...
"""menampilkan frekuensi user id Berdasarkan Transaksi"""
...
menampilkan jumlah nilai null pada dataframe all_transaksi_name
"""
...
menghapus nilai null pada kolom country di dataframe all_transaksi_name dan membuat dataframe baru all_transaksi_name_clean
"""

all_transaksi_name_clean = all_transaksi_name.dropna(subset=['country'])

"""drop kolom variant pada dataframe all_transaksi_name_clean"""

all_transaksi_name_clean = all_transaksi_name_clean.drop('variant', axis=1)

"""### Mengatasi Duplicated Value

menampilkan nama barang Android Hipster Pin
"""
...
menampilkan dataframe berdasarkan item_id dari yang terkecil
"""

fix_transaksi = all_transaksi_name_clean.sort_values('item_id', ascending=True)
print(fix_transaksi)

"""menampilkan jumlah nilai unik pada kolom item_id"""
...
"""membuat dataframe preparation"""

preparation = fix_transaksi
preparation.sort_values('item_id')

"""menghapus nilai item_id duplicate value pada dataframe preparation"""
...
Mengonversi data series ‘item_id’, ‘Name’  dan ‘category’  menjadi dalam bentuk list
"""
...
"""melakukan Inisialisasi TfidfVectorizer, perhitungan idf pada data category dan Mapping array dari fitur index integer ke fitur nama"""
...
"""Membuat dataframe untuk melihat tf-idf matrix, Kolom diisi dengan jenis masakan, Baris diisi dengan nama barang"""
...
"""Membuat dataframe dari variabel cosine_sim dengan baris dan kolom berupa nama barang dan melihat similarity matrix pada setiap item"""
...
membuat fungsi barang_recommendations
"""
...
"""menampilkan data dengan nama barang Google Flat Front Bag Grey"""

data[data.nama_barang.eq('Google Flat Front Bag Grey')]

"""menampilkan hasil output fungsi barang_recommendations"""
...
pada kolom event_type dan menampilkan 5 data teratas all_transaksi_name_clean
"""
...
"""membuat dataframe df yang didalamnya hanya ada user_id, item_id dan event_type diambil dari dataframe all_transaksi_name_clean"""

df = all_transaksi_name_clean[['user_id', 'item_id', 'event_type']]

"""Mengubah user_id menjadi list tanpa nilai yang sama, Melakukan encoding user_id, Melakukan proses encoding angka ke ke user_id"""
...
"""Mengubah item_id menjadi list tanpa nilai yang sama, Melakukan proses encoding item_id Melakukan proses encoding angka ke item_id."""
...
"""Mapping user_id ke dataframe user dan Mapping item_id ke dataframe item"""
...
"""Mendapatkan jumlah user, Mendapatkan jumlah item, Mengubah event_type menjadi nilai float, mengambil Nilai minimum event_type, mengambil Nilai maksimal event_type dan menampilkannya"""
...
"""Membuat variabel x untuk mencocokkan data user dan item menjadi satu value, Membuat variabel y untuk membuat event_type dari hasil dam Membagi menjadi 80% data train dan 20% data validasi dan menampilkan hasilnya"""
...
menampilkan visualisasi metrik training
"""
